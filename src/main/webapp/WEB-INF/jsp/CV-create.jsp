                                                ...
                                                <br>
                                                    ...
                                                    <div class="education_cv">
                                                        ...
                                                        <div class="input_education">
                                                            <input type="text" name="" id="" style="width: 60px; border: .5px dashed #ccc;"  placeholder="08-2024">
                                                                <input type="text" name="" id="" style="width: 60px; border: .5px dashed #ccc;"  placeholder=12-2023">
                                                                    </div>
