...
public class CompanyRepositoryImpl implements CompanyRepository {
    ...
    public List<Object[]> getListCompany(int page) {
        ...
        q.where(b.equal(rC.get("id"), rJ.get("companyID")),
                b.equal(rC.get("isChecked"), 1), b.equal(rC.get("isDeleted"), 0));
    ...
    public Company getDetailCompany(int companyId) {
        Session s = this.sessionFactory.getObject().getCurrentSession();
        Query q = s.createQuery("From Company where id =: comId AND isChecked = : check AND isDeleted =: delete");
        q.setParameter("comId", companyId);
        q.setParameter("check", 1);
        q.setParameter("delete", 0);
    ...
    public List<Company> getListCompany() {
        Session s = this.sessionFactory.getObject().getCurrentSession();
        Query q = s.createQuery("From Company WHERE isChecked =: check AND isDeleted =: delete");
        q.setParameter("check", 1);
        q.setParameter("delete", 0);
    ...
    public long countCompany() {
        Session s = this.sessionFactory.getObject().getCurrentSession();
        Query q = s.createQuery("SELECT COUNT(*) From Company WHERE isChecked =: check AND isDeleted =: delete");
        q.setParameter("check", 1);
        q.setParameter("delete", 0);
